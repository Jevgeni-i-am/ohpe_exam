...
def admin_menu():
    """Näyttää käyttöliittymän ADMIN-oikeuksilla"""
    while True:
        print("")
        funktiot.hidas_tekstin_printtaus(
            "ADMIN, tervetuloa moderointi valikkoon!\n", 0.025)
        print("")
        print("Mitä haluat tarkistaa?")
        print("Valitse seuraavista vaihtoehdoista:")
        print("")
        print("1.- Selaa kaikki näytökset   ### _____OK")
        print("2.- Kaikki salit   ### _____NOK")
        print("3.- Kaikki näytökset   ### _____NOK")
        print("4.- Valitse istumapaikka   ### _____NOK")
